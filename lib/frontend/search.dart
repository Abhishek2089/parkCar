              ...
              children: <Widget>[
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text("Number of adults",style: TextStyle(fontSize: 15),),
                          Counter(
                            minValue: 0,
                            maxValue: 10,
                            decimalPlaces: 0,
                  ...
                  child: Material(
                    ...
                    //  margin: EdgeInsets.symmetric(vertical: 10),
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text("Number of Vehicles",style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,),
                         Counter(
                            minValue: 0,
                            maxValue: 10,
                            decimalPlaces: 0,
               ...
               Padding(
                ...
                Padding(
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Prices".toUpperCase(),style: TextStyle(color: Colors.grey,fontSize: 12,),),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(15),
                ...
                Padding(
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Choose the date of your parking".toUpperCase(),style: TextStyle(color: Colors.grey,fontSize: 12,),),
                  ),
                ),
                dp.RangePicker(
