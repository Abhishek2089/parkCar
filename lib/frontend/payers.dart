                 ...
                 children: <Widget>[
                   ...
                   Flexible(
                     child: Column(
                       ...
                       crossAxisAlignment: CrossAxisAlignment.start,
                       children: <Widget>[
                         Text("Parking",style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 10,),
                         Text("Parking",style: TextStyle(fontSize: 16),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 8,),
                         Text("Parking",style: TextStyle(fontSize: 16),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 8,),
                         Row(
